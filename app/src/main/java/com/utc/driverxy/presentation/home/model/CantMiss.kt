...
enum class CantMiss(val title: Int, val subTitle: Int, val icon: Int) {
    SCAN_TRAFFIC(R.string.scan_traffic_signs, R.string.scan_traffic_signs_description, R.drawable.ic_camera),
    ...
    NOTED(R.string.noted, R.string.noted_description, R.drawable.ic_noted)
}