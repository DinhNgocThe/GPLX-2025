...
import com.utc.gplx2025.navigation.NavRoutes
import com.utc.gplx2025.presentation.theme.AppTheme
...
/*
    ...
    Màu nền của các screen sẽ là MaterialTheme.colorScheme.background.
    Màu chữ thì thường sẽ thêm tiền tố "on" ví dụ: onSurface, onPrimary, ...
    Màu chữ mà nằm trực tiếp trên nền thì dùng onBackground.
